...
function App() {
  return (
    <Fragment>
      ...
      <div className="flex justify-between items-center py-4 px-4">
        <div>
          <ul className="flex flex-row font-bold items-center text-sm">
            ...
            <li className="px-2 cursor-pointer ">MENU</li>
            <li className="px-2 cursor-pointer ">REWARDS</li>
            <li className="px-2 cursor-pointer ">GIFT CARDS</li>
          </ul>
        </div>
      ...
      <div className="xl:mx-40 mt-10">
        {/* <!-- HERO-1 --> */}
        <div className="flex flex-col lg:flex-row bg-starGreen">
          <div className="flex-none md:w-6/12 relative">
            <div
              className="absolute w-full h-full bg-[url('./assets/images/1.webp')] bg-contain lg:bg-cover lg:bg-center"
            ></div>
          </div>
          <img src={image1} className="lg:hidden" alt='img' />
          <div>
            <div className="p-10 sm:p-24 mx-12 text-center">
              <p className="text-[50px] font-bold">Sign up for Starbucks® Rewards</p>
              <p className="text-[24px]">
                Starting 4/22, get 25 Stars when you bring your clean, reusable
                cup into the café. Stars can quickly add up to Rewards.*
              </p>
              <button
                className="hover:bg-slate-50 border-solid border-black border-2 rounded-full px-5 py-1 mt-2 text-center font-bold"
              >
                Join now
              </button>
            </div>
        ...
        <div className="flex flex-col lg:flex-row bg-starGreen mt-8">
          <div>
            <div className="p-10 sm:p-24 mx-12 text-center">
              <p className="text-[50px] font-bold">Planet-positive tips</p>
              <p className="text-[24px]">
          ...
          <div className="flex-none md:w-6/12 relative">
            <div
              className="absolute w-full h-full bg-[url('./assets/images/2.webp')] bg-contain lg:bg-cover lg:bg-center"
            ></div>
          </div>
          <img src={image2} className="lg:hidden" alt='img' />
        </div>
        ...
        <div className="flex flex-col lg:flex-row bg-darkGreen mt-8 text-white">
          <div className="flex-none md:w-6/12 relative">
            <div
              className="absolute w-full h-full bg-[url('./assets/images/3.jpg')] bg-contain lg:bg-cover lg:bg-center"
            ></div>
          </div>
          <img src={image3} className="lg:hidden" alt='img' />
          <div>
            <div className="p-10 sm:p-24 mx-12 text-center">
              <p className="text-[50px] font-bold text-black">Iced shaken awakening</p>
              ...
              <button
                className="hover:bg-slate-50 hover:text-black border-solid border-white border-2 rounded-full px-5 py-1 mt-2 text-center font-bold"
              >
                Order now
              </button>
            </div>
        ...
        <div className="flex flex-col lg:flex-row bg-darkGreen text-white mt-8">
          <div>
            <div className="p-10 sm:p-24 mx-12 text-center">
              <p className="text-[50px] font-bold text-black">Taste of tomorrow</p>
              <p className="text-[24px] text-black">
          ...
          <div className="flex-none md:w-6/12 relative">
            <div
              className="absolute w-full h-full bg-[url('./assets/images/4.jpg')] bg-contain lg:bg-cover lg:bg-center"
            ></div>
          </div>
          <img src={image4} className="lg:hidden" alt='img' />
        </div>
      </div>
      ...
      <footer>
        <div
          className="grid grid-cols-2 md:grid-cols-4 mx-10 md:mr-44 text-lightText"
        >
          <ul>
            <p className="font-semibold text-titleText">About us</p>
          ...
          <ul>
            <p className="font-semibold text-titleText">Careers</p>
          ...
          <ul>
            <p className="font-semibold text-titleText">Social Impact</p>
          ...
          <ul>
            <p className="font-semibold text-titleText">Order and Pickup</p>
        ...
        <div className="text-titleText mt-8 flex justify-evenly w-60">
        ...
        <div className="flex justify-evenly w-fit mt-8 mx-10 ">
          <p>Privacy Policy</p>
          <p>|</p>
          <p>Term of Use</p>
          <p>|</p>
        ...
        <p className="text-lightText my-4 mx-10">
